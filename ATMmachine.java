...
Create 10 accounts with id AC001…..AC010 with initial balance 300₹. The system prompts the users to enter an id. If the id is entered incorrectly, 
...
{ 
   ...
   { 
      ...
      { 
        ...
        if(i==arrL.size())
        System.out.println("Incorrect ID!!! Enter valid id ");
        else
        break;
      }while(true);
      switch(temp)
